...
contract UnitApproveActionsBuilder is UnitSafeEntrypoint {
  ...
  function test_ExtendActionsBuilderApprovalWhenCallerIsSafe(
    address _actionsBuilder,
...
contract UnitDisapproveSafeTransactionHash is UnitSafeEntrypoint {
...
contract UnitQueueTransaction is UnitSafeEntrypoint {
  ...
  function test_QueueApprovedTransactionWhenPassingValidParameters(
    address _caller,
    address _actionsBuilder,
    uint256 _expiryDelay
  ...
  function test_QueueArbitraryTransactionWhenPassingValidParameters(
    address _caller,
    address _target,
    uint256 _value,
    bytes memory _data,
  ...
  function test_QueueApprovedTransactionWhenCallerIsNotSafeOwner(
    address _caller,
    address _actionsBuilder,
    uint256 _expiryDelay
  ) external givenCallerIsNotSafeOwner(_caller) {
  ...
  function test_QueueArbitraryTransactionWhenCallerIsNotSafeOwner(
    address _caller,
    address _target,
    uint256 _value,
    bytes memory _data,
    ...
    vm.expectRevert(ISafeManageable.NotSafeOwner.selector);
    vm.prank(_caller);
    safeEntrypoint.queueTransaction(_actions[0], _expiryDelay);
  }
}

contract UnitExecuteTransaction is UnitSafeEntrypoint {
  function test_ExecuteTransactionWithoutSignersWhenTransactionIsExpired(
    address _caller,
    uint256 _txId,
  ...
  function test_ExecuteTransactionWithoutSignersWhenApprovedTransactionIsAlreadyExecuted(
    address _caller,
    uint256 _txId,
    IActionsBuilder.Action calldata _action,
    ISafeEntrypoint.TransactionInfo memory _txInfo
  ...
  function test_ExecuteTransactionWithoutSignersWhenApprovedTransactionIsNotYetExecutable(
    address _caller,
    uint256 _txId,
    IActionsBuilder.Action calldata _action,
    ISafeEntrypoint.TransactionInfo memory _txInfo
  ...
  function test_ExecuteTransactionWithSignersWhenTransactionIsValid(
    address _caller,
    address _signer1,
    address _signer2,
    uint256 _txId,
...
contract UnitGetSafeTransactionHash is UnitSafeEntrypoint {
  ...
  function test_GetApprovedHashSignersWhenGettingSignersWithNonce(
    address _signer1,
    address _signer2,
    uint256 _txId,
    IActionsBuilder.Action memory _action,
