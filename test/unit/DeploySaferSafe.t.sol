...
contract UnitDeploySaferSafe is Constants, Test {
  ...
  function test_WhenRun() public {
    ...
    ICappedTokenTransfersFactory _cappedTokenTransfersFactory = deploySaferSafe.cappedTokenTransfersFactory();
    ...
    // It should deploy the CappedTokenTransfersFactory contract
    assertEq(address(_cappedTokenTransfersFactory).code, type(CappedTokenTransfersFactory).runtimeCode);
